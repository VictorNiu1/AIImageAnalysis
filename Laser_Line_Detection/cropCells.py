...
flags.DEFINE_string('image_input_folder', r"C:\Users\Victor\Documents\GitHub\AIImageAnalysis\Laser_Line_Detection\results", 'Path to the folder containing the TIFF files')
flags.DEFINE_string('image_output_folder', r'C:\Users\Victor\Documents\GitHub\AIImageAnalysis\Laser_Line_Detection\results\output', 'Path to the folder where the output will be saved')
